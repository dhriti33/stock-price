...
getGoogleArray(){
      ...
      for (var i = 0; i < this.state.li.length; i++){
        this.state.Combined[i + 1] = [this.state.li[i], this.state.stockData[i], "color: #1337B7"  ];    
    }
}
...
render() {
  ...
  return (
        ...
        {this.state.Combined.length > 1 ? <Chart chartType="BarChart" width="100%" height="400px" data={this.state.Combined}/> : '' }
      </div>
